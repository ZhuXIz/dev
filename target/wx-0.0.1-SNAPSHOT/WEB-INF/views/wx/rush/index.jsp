			...
			success: function(msg){
				if (msg) {
					...
					'<img src="${pageContext.request.contextPath}'+obj.titleImage+'">'+
							...
							'</div>'+
							'<div class="btm">'+
								'<div class="btm_tit">'+titleName+
								'<div class="btm-b">'+
									'<div class="btm-info">'+
										'<div class="btm_price fmt-price">'+
											'<div class="now color-pri">'+
												'<span class="dollar">¥</span> <span class="price">'+obj.price+'</span>'+
											'</div>'+
					...
					html=titleHtml+
							'<img'+
							'	src="${pageContext.request.contextPath}'+obj.titleImage+'">'+
						'</div>'+
					'</div>'+
					'<div class="btm">'+
...
<body class="bg_f5">
	<div id="main">
		...
		<div class="g-wrap-c" id="main">
			<div class="hd-head bottom-line" style="width: 100%; height: 100%;">
				<div id="ih-scroll" style="width: 102%; height: 100%;">
					<ul class="typeParent" style="width: 100%; height: 100%;">
		...
		<ul class="pager">
			<li role="presentation" class="active"><a class="type"
				id="type2" onclick="changeType(2,1);">美食</a></li>
			<li role="presentation"><a id="type1"
				onclick="changeType(1,1);">旅游</a></li>
			<li role="presentation"><a id="type3" onclick="changeType(3,1)">KTV</a></li>
			<li role="presentation"><a id="type4" onclick="changeType(4,1)">服装</a></li>
			<li role="presentation"><a id="type5" onclick="changeType(5,1)">其他生活服务</a></li>
		</ul>
-->

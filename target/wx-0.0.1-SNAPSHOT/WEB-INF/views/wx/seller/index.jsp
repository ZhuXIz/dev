					...
					success : function(msg) {
						...
						if(msg!=null){
							...
							$.each(msg.rows,function(index,obj){
			                    ...
			                    "<img src='"+obj.titleImage+"'></div> </div>"+
							...
							// 	"&nbsp;&nbsp;<button class='btn btn-danger' onclick='removeGoods("+obj.id+")'' >删除</button>"+
								...
								$('.sellerContent').append(goodsHtml);
...
<body>
	<div class="message"
		style="color: blank; height: 40px; text-align: center;">
		<div class="messageLeft">
			<span id="item" onclick="getSeller()">我的商铺</span>
		</div>
		<div class="messageRight">
			<span id="evaluate" onclick="getGoods(1)">促销活动</span>
		</div>
	</div>

			...
			function check(id){
				...
				function noteshtml(id) {
					...
					if(id!=null|typeof(id)!='undefined'){
						$.ajax({
							...
							success : function(msg) {
								if(msg){
									...
									"</div>" +
									"<div class='cell-item'>" +
									"<label class='cell-left label_name'>密&nbsp;&nbsp;&nbsp;码:</label>" +
									"<div class='cell-right'><input id='pwd'  type='text'  value='"+msg.pwd+"' class='addtext width100b'></div>" +
									"</div>" +
									"<div class='cell-item'>" +
									"<label class='cell-left label_name'>权&nbsp;&nbsp;&nbsp;限:</label>" +
									"<div class='cell-right'><select id='permiss'>" +
								   	"</select>" +
								   	"</div>" +
									"</div>" +
						...
						"<div class='cell-item'>" +
						"<label class='cell-left label_name'>密&nbsp;&nbsp;&nbsp;码:</label>" +
						"<div class='cell-right'><input id='pwd'  type='text'  value='' class='addtext width100b'></div>" +
						"</div>" +
						"<div class='cell-item'>" +
						"<label class='cell-left label_name'>权&nbsp;&nbsp;&nbsp;限:</label>" +
						"<div class='cell-right'><select id='permiss' >" +

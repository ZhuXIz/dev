			...
			success: function(msg){
				if(msg){
					...
					$.each(msg.rows,function(index,obj){
                        ...
                        "<span class='num'><i class='iconfont'></i>商家:"+sellerName+"</span>"+
                        "<span class='date'>"+obj.oTime+"</span>"+
				           "</div>"+
				           "<div class='row_m'>"+
				              	"<div class='pic'><img src='${pageContext.request.contextPath}"+obj.goods.titleImage+"'>"+
								"</div>"+
					...
					"</li>";
						...
						"</li>";
							...
							html+="<div class='order_func'>"+
							"<span class='indate'>*有效期至："+obj.goods.sufTime+"</span>"+
							"<div class='btn_box'><a onclick='javascript:pay()' class='btn btn-used'>立即支付</a>"+
							"</div>"+
						"</div>"+
					"</li>";
							...
							//4==拼团任务（未完成/提示申请退款）
								html+="<div class='order_func'>"+
							"<span class='indate'>*有效期至："+obj.goods.sufTime+"</span>"+
							"<div class='btn_box'><a onclick='javascript:pay_back()' class='btn btn-used'>申请退款</a>"+
							"</div>"+
						"</div>"+
					"</li>";
